        ...
        <div class="jumbotron">
            ...
            <div class="col-sm-8 w3-card">
                ...
                <footer class="w3-container">
                    ...
                    <div class="col-sm-2">
                        <button id="send" onclick="send()" class='w3-button w3-teal' style="border-radius: 0; float:right"><span style="font-size: 30px"class="glyphicon glyphicon-send glyphicon-lg"></span></button>
                    </div>
                </footer>
            </div>
        </div>
                ...
                xmlhttp.onreadystatechange = function () {
                    if (this.readyState == 4 && this.status == 200) {
                        if (this.responseText == -1)
                        {
                            ...
                            div.innerHTML = "<div class='container'><div class='container_right'><p class='time-right'>" + message + "</p><span class='time-left'>" + myDate + "</span></div></div>";
                            theDiv.appendChild(div);
                            theDiv.scrollTop = theDiv.scrollHeight;
                        }
                    }
                };
                xmlhttp.open("GET", "message_backend.php?q=" + message, true);
                xmlhttp.send();
