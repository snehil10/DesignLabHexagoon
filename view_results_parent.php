...
<html>
    ...
    <center>
        <div class="w3-container" id="examtype" style="width: 1100px">
            <div class="w3-card">  
                <form method="post" action="view_results_parent.php">
                    ...
                    <div id='course' class="w3-container">
                        <table class="w3-table-all w3-hoverable">
                            ...
                            if (isset($_POST['submit'])) {
                                ...
                                $sql1 = "select student.semester,student.stream,course_name,course_id from student join courses on courses.department_id=student.stream and courses.semester=student.semester where student.username='" . $student_id . "'";
                                ...
                                if (!$result1) {
                                    ...
                                    $sql2 = "select " . $row['course_id'] . " from $table_name where student_id='" . $student_id . "' and exam_type='" . $exam_type . "'";
