    ...
    <body id = 'student_info' class="w3-light-grey">
                ...
                <div id='course' class="w3-container">
                    <table class="w3-table w3-bordered">
                        ...
                        <tr>
                            ...
                            <td>Ee-kian Wong</td>
                            <td><button class='w3-button w3-teal'>View Results</button></td>
	  ...
	  <div class="w3-container w3-card w3-white">
          <h2 class="w3-text-grey w3-padding-16"><i class="fa fa-certificate fa-fw w3-margin-right w3-xxlarge w3-text-teal"></i>Activities</h2>
            <div class="w3-container">
                <p class='w3-text-grey'>Evaluate your teachers on their performance, once a month.</p>
                <button class='w3-button w3-teal'>Teacher Evaluation</button>
                <hr>
            </div>
          <div class="w3-container">
                <p class='w3-text-grey'>Vote for your favorite teacher this semester.</p>
                <button class='w3-button w3-teal'>Online Polls</button>
                <hr>
            </div>
      </div>
